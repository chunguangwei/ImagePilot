...
const BUILTIN_ICON_META = {
  ...
  kids: { iconName: 'child-care', color: '#FF9800' },
  night_scene: { iconName: 'nightlight', color: '#3F51B5' },
  architecture: { iconName: 'apartment', color: '#795548' },
  plants: { iconName: 'local-florist', color: '#4CAF50' },
  vehicles: { iconName: 'directions-car', color: '#FF5722' },
  sports: { iconName: 'fitness-center', color: '#009688' },
  fashion: { iconName: 'checkroom', color: '#E91E63' },
  products: { iconName: 'shopping-bag', color: '#00BCD4' },
  documents: { iconName: 'description', color: '#607D8B' },
  art: { iconName: 'palette', color: '#9C27B0' },
